...
urlpatterns = [
    ...
    path('ip', views.ip_info, name='ip'),
    path('contact/', views.contact, name='contact'),
    path('detect', views.detectBrowser),
    path('password', views.pass_generator),
    path('ytd', views.down_ytd),
    path('ipfinder', views.ipfinder),
    ...
    # path('ip_address', views.visitor_ip_address, name='visitor_ip_address'),
